...
<h2 style="color:#163260;">Hubungi Kami</h2>
...
<div class="sect">
    <div class="contain">
<h4><div class="kiridua" style="color:#163260;">Sampaikan keluhan Anda, melalui :</div>
    <table class="kiri" style="color:#163260;">
        <tr>
            <td>
        ...
        <tr>
            ...
            <td><a style="color:#163260;" href="<?php echo $hasil16['isi'];?>"><?php echo $hasil16['about'];?></a></td>
        </tr>
    </table>
</h4>
...
<div class="sect">
    <div class="contain">
    <iframe style="margin:0 auto 100px auto; border:none;" src="<?php echo $hasil15['isi'];?>" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</div>
