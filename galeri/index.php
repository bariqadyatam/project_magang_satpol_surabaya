    ...
    <nav class="navbar">
            ...
            <div class="navbar-links" id="navbar2">
                <ul>
                    ...
                    <a href="#home" class="btn garisbawah" style="white-space:nowrap;" ><li>Galeri Kegiatan</li></a>
...
<div class="sect">
    <div class="contain">
        <h3 style="color:#163260;">Galeri Kegiatan</h3>
    </div>
</div>
<?php
error_reporting(0);
...
while($hasil= mysqli_fetch_array($query)){
    $foto.="
    <div class='x'>
    <img src='../$hasil[foto]' alt='Image 1' class='thumbnail' onclick='openModal(\"../" . $hasil['foto'] . "\")' />
    </div>
";
}
?>
