                ...
                <ul>
                    ...
                    <li class="dropdown btndua">
                        ...
                        <div class="dropdown-content">
                            <a href="#home">Struktur Organisasi</a>
                            <a href="../sejarah/">Sejarah</a>
                            <a href="../tupoksi/">Tupoksi</a>
                        </div>
                        <div class="menumuncul">
                            <ul>
                            <li><a href="#home">Struktur Organisasi</a></li><br>
...
<div class="sect">
    <div class="contain">
            ...
            <div class="judul">
            <h3 style="color:#163260;">Struktur Organisasi
                Satuan Polisi Pamong Praja Kota Surabaya</h3>
            </div>

            <div class="logosatpol">
                <img src="../img/logosatpolpp.jpg" style="width:100%;" alt="">        
            </div>
    </div>
</div>
...
<div class="sect">
    ...
    <center>
    <img src="../<?php echo $hasil['about'];?>" width="80%" />
    </center>
