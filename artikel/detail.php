...
$query = mysqli_query($con,"SELECT * from artikel where `url`='$_GET[url]'");
$hasil = mysqli_fetch_array($query);
?>

<div class="sect">
    <div class="contain">
        <div class="tujuhpuluh pd" style="display:inline-block; position:relative; ">
            <img src="../<?php echo $hasil['gambar'];?>" width="100%" alt="Ganti Foto"><br>
            <p>
  ...
  <path d='M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2'/>
            ...
            <?php echo $hasil['tgl'];?></p>
        <h3><?php echo $hasil['judul'];?></h3>
        <p><?php echo $hasil['isi'];?></p>
        </div>

<?php
$beritaq = mysqli_query($con,"SELECT * from artikel where `kategori`='Berita Terbaru' order by id desc");
while($beritah = mysqli_fetch_array($beritaq)){
    $out = strlen($beritah['judul']) > 50 ? substr($beritah['judul'],0,50)."..." : $beritah['judul'];
    $beritax.="
    <div style=' padding:20px 0 20px 0; display:flex; border-bottom:1px solid #e3e3e3;'>
        <div style='width:40%; display:inline-block; position:relative; background-image:url(../$beritah[gambar]); background-size:cover; background-position:center; height:100px;'>
        </div>
        <div style='width:60%; display:inline-block; position:relative; padding:10px;'>
            <span>
            <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-calendar3' viewBox='0 0 16 16'>
  <path d='M14 0H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2M1 3.857C1 3.384 1.448 3 2 3h12c.552 0 1 .384 1 .857v10.286c0 .473-.448.857-1 .857H2c-.552 0-1-.384-1-.857z'/>
  <path d='M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2'/>
            ...
            $beritah[tgl]</span><br>
            <a class='biru' href='$beritah[url]'>$out</a>
        </div>
    </div>
    ";
}
?>
        ...
        <div class="tigapuluh" style="display:inline-block; position:relative;">

        <div style="width:100%; align-content:center; display:block;">
    <div class="sect visi" style="background:#d1d1d1; height:40px; position:absolute; display:inline-block; z-index:10; margin-top:10px;">
    </div>
<center>
    <div class="misi dualima" style="background:#127d57; height:60px; border-radius:10px; position:relative; display:inline-block; margin-right:auto; margin-left:auto; color:white; align-content:center; font-weight:bold; letter-spacing:2px; font-family:Arial; z-index:20;">
        Berita Terbaru
    </div>
</center>
    <div style=" overflow:auto; height:500px; border-bottom:1px solid #e3e3e3; margin-top:10px;">
        <?php echo $beritax;?>
    </div>
</div>
        </div>
